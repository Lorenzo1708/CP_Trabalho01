...
void kMeansClustering(vector<Point>* points, int epochs, int k, int noThreads) {
    ...
    {
        case 1:
            myfile.open("Output_1_Thread.csv");
            
            break;

        case 2:
            myfile.open("Output_2_Threads.csv");
            
            break;

        case 4:
            myfile.open("Output_4_Threads.csv");
            
            break;

        case 8:
            myfile.open("Output_8_Threads.csv");
